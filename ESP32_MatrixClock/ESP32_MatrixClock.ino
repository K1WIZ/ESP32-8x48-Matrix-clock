...
// Timezone -------------------------------------------
#define TZName       "EST5EDT,M3.2.0,M11.1.0"   // US Eastern  (examples see at the bottom)
...
// other defines --------------------------------------
#define BRIGHTNESS   8     // values can be 0...15
#define anzMAX       8     // number of cascaded MAX7219
